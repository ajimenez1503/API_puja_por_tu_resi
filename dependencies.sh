...
############################################################
crontab -l | { cat; echo "0 23 * * *  python3.5 /home/jimenez/Desktop/API_puja_por_tu_resi/periodical_request/assigne_room.py >> /home/jimenez/Desktop/API_puja_por_tu_resi/periodical_request/output_log.txt"; } | crontab -
############################################################
#DEPLOYMENT CLIENT
############################################################
cd /var/www/html/
